...
public class SeleniumListeners implements IInvokedMethodListener, ITestListener, ISuiteListener{
	...
	public void afterInvocation(IInvokedMethod method, ITestResult testResult) {
		// TODO Auto-generated method stub
		//before each and every method - be it b4 class, after class, testmethod1 or testmethod2
		//using reporter.log instead of sysout statement
	...
	public void onTestStart(ITestResult result) {
		// When test method starts such as testmethod1
